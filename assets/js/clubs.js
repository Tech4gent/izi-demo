...
/* ============================================================
   Прайс по клубам. Зоны и цены у клубов разные, поэтому таблица
   строится из этих данных, а не лежит в разметке.
   Подтверждён только клуб на Белорусской (макет клиента от 26.04.2026).
   TODO: вписать таблицы остальных клубов, когда клиент их пришлёт -
   больше ничего править не надо, вкладки и колонки соберутся сами.
   ============================================================ */
const PRICE_REF = 'bel'; // чей прайс показываем как образец, пока нет своего
const PRICES = {
  bel: {
    zones: [
      { name: 'COMFORT', spec: 'RTX 3070 · 280 Гц' },
      { name: 'VIP', spec: 'RTX 4070 SUPER · 400 Гц' },
      { name: 'SUPER DUO', spec: 'RTX 5080 · 600 Гц', duo: true },
    ],
    rows: [
      { name: 'Почасовая · день', time: '08:00-14:00', wd: [180, 290, 580], we: [220, 330, 640] },
      { name: 'Пакет · день 3 часа', time: '08:00-14:00', wd: [490, 800, 1600], we: [610, 910, 1820] },
      { name: 'Пакет · день 5 часов', time: '08:00-13:00', wd: [790, 1260, 2520], we: [960, 1440, 2940] },
      { name: 'Почасовая · вечер и ночь', time: '14:00-08:00', wd: [220, 330, 640], we: [260, 360, 740] },
      { name: 'Пакет · вечер 3 часа', time: '14:00-08:00', wd: [620, 940, 1820], we: [740, 1030, 2110] },
      { name: 'Пакет · вечер 5 часов', time: '13:00-08:00', wd: [1010, 1520, 2940], we: [1190, 1660, 3410] },
      { name: 'Пакет · ночь 10 часов', time: '23:00-09:00', wd: [1090, 1640, 3190], we: [1290, 1790, 3690] },
    ],
  },
};
